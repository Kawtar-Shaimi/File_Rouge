...
@section('head')
    @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/admin/payments/changeStatusInputValidation.js'])
@endsection
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <form id="update-form" action="{{ route('admin.payments.update', $payment->uuid) }}" method="POST">
                        ...
                        <button id="update-status" type="submit"
                            class="w-full bg-purple-400 text-white p-3 rounded-lg hover:bg-blue-700 transition">Change
                            Status</button>
                    </form>
                </div>
            </div>
