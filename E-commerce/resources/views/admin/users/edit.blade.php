...
@section('head')
    @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/admin/users/updateInputValidation.js'])
@endsection
                    ...
                    <form id="update-form" action="{{ route('admin.users.update', $user->uuid) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="role" id="role" class="w-full mt-2 p-2 border rounded-lg">
                                ...
                                <option @if ($user->role == 'publisher') selected @endif value="publisher">Publisher
                                </option>
                            </select>
                        </div>
                        ...
                        <button id="update-user" type="submit"
                            class="w-full bg-purple-400 text-white p-3 rounded-lg hover:bg-blue-700 transition">Update Role</button>
                    </form>
                </div>
            </div>
        </div>
