...
@section('head')
    @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/admin/books/book.js'])
@endsection
                    ...
                    <table class="w-full border-collapse">
                        <tr>
                            ...
                            <td class="p-3 border underline italic hover:text-blue-400"><a
                                    href="{{ route('admin.books.show', $book->uuid) }}">#{{ $book->uuid }}</a></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="p-3 border underline italic hover:text-blue-400"><a
                                    href="{{ route('admin.categories.show', $book->category->uuid) }}">#{{ $book->category->uuid }}</a>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="p-3 border underline italic hover:text-blue-400"><a
                                    href="{{ route('admin.users.show', $book->publisher->uuid) }}">#{{ $book->publisher->uuid }}</a>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="p-3 border">
                                <form id="delete-form" action="{{ route('admin.books.delete', $book->uuid) }}"
