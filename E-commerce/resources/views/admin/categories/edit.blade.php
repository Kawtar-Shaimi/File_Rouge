    ...
    <div class=" max-w-4xl mx-auto">
        <div class="mt-10">
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <form id="update-category-form" action="{{ route('admin.categories.update', $category->uuid)  }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" name="description" rows="3" required
                            class="w-full mt-2 p-2 border rounded-lg">{{ old('description', $category->description) }}</textarea>
                    </div>
