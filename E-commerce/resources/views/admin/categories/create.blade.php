                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <form id="create-category-form" action="{{ route('admin.categories.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" rows="3" required class="w-full mt-2 p-2 border rounded-lg">{{ old('description') }}</textarea>
                        </div>
                        ...
                        <button id="create-category" type="submit"
                            class="w-full bg-purple-400 text-white p-3 rounded-lg hover:bg-blue-700 transition">Add
                            Category</button>
                    </form>
                </div>
            </div>
