            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <table class="w-full border-collapse">
                    <tr>
                        ...
                        <td class="p-3 border underline italic hover:text-blue-400"><a href="{{ route('publisher.products.show', $product) }}">#{{ $product->id }}</a></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="p-3 border">
                            <a class="bg-blue-500 text-white px-3 py-1 rounded" href="{{ route('publisher.products.edit', $product->id) }}">Modifier</a>
                            <form action="{{ route('publisher.products.delete', $product) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
