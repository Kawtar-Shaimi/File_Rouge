...
<div class="container w-5/6 ms-auto p-6">
    <div class="max-w-lg mx-auto">
        <h2 class="text-3xl font-bold text-center mb-6 text-gray-800">✏️ Modifier le Book</h2>
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg">
            <form action="{{ route('publisher.books.update', $book->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <!-- Image Preview -->
                <div class="mb-4">
                    <label for="image_preview" class="block text-sm font-medium text-gray-700">Image du book</label>
