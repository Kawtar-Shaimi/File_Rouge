...
@section('head')
    @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/publisher/books/updateInputValidation.js'])
@endsection
    ...
    <div class="container w-5/6 ms-auto p-6">
        <div class="max-w-lg mx-auto">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg">
                <form id="updateBookForm" action="{{ route('publisher.books.update', $book->uuid) }}" method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="name" name="name" class="w-full p-3 border rounded-lg mt-1"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" id="price" name="price" step="0.01" min="0"
                            class="w-full p-3 border rounded-lg mt-1" value="{{ old('price', $book->price) }}" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="category_id" name="category_id" class="w-full p-3 border rounded-lg mt-1" required>
                            ...
                            @foreach ($categories as $category)
                                <option @if ($category->id === $book->category_id) selected @endif value="{{ $category->uuid }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" id="stock" name="stock" min="1"
                            class="w-full p-3 border rounded-lg mt-1" value="{{ old('stock', $book->stock) }}" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <img id="image_preview" src="{{ asset('storage/' . $book->image) }}" alt="{{ $book->name }}"
                    ...
                    <!-- Submit Button -->
                    <button id="update-book" type="submit"
                        class="w-full bg-purple-400 text-white font-bold py-3 rounded-lg mt-6 hover:bg-green-600 transition duration-300 shadow-md">
                        Update Book
                    </button>
