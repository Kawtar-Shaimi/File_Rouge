                ...
                <form id="createBookForm" action="{{ route('publisher.books.store') }}" method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" id="price" name="price" step="0.01" min="0"
                            class="w-full p-3 border rounded-lg mt-1" value="{{ old('price') }}" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" id="stock" name="stock" min="1"
                            class="w-full p-3 border rounded-lg mt-1" value="{{ old('stock') }}" required>
                    </div>
                    ...
                    <button id="add-book" type="submit"
                        class="w-full bg-purple-400 text-white font-bold py-3 rounded-lg mt-6 hover:bg-blue-600 transition duration-300 shadow-md">
                        Add Book
                    </button>
