<aside class="w-1/6 bg-gray-800 text-white h-screen fixed">
    ...
    <nav class="mt-6">
        ...
        <a href="{{ route('notifications.publisher') }}" class="block px-4 py-2 hover:bg-gray-700">Notifications <span id="notification-count" class="bg-red-500 text-white px-2 py-0.5 rounded-full ms-5">{{ Auth::guard('publisher')->user()->unreadNotifications->count() }}</span></a>
