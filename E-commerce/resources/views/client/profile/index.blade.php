...
<div class="container mx-auto p-8">
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-xl space-y-6">
        ...
        <div class="flex items-center justify-between space-x-8 border-b pb-6">
            ...
            <a href="{{ route('client.edit') }}" class="px-6 py-2 bg-purple-400 text-white font-semibold rounded-lg shadow-md hover:bg-indigo-700 transition-all duration-300">
                Modifier le Profil
            </a>

            <a class="px-6 py-2 bg-gray-400 text-white font-semibold rounded-lg shadow-md hover:bg-indigo-700 transition-all duration-300">
                Reset password
            </a>
        </div>
