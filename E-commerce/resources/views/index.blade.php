                                ...
                                <div class="px-5 pb-5 pt-0">
                                    <div id="actions" class="flex items-end space-x-1">
                                        ...
                                        <div id="toggleWishlistBtn-{{ $book->uuid }}"
                                            class="w-1/4 inline-flex justify-center items-center" 
                                            ...
                                            <div class="flex justify-center items-center w-10 h-10 cursor-pointer" style="outline:none !important; -webkit-tap-highlight-color: transparent !important;">
                                                <svg class="w-6 h-6 transition-transform duration-200 transform hover:scale-110 {{ $book->isInWishlist ? 'text-red-500 fill-red-500' : 'text-gray-400 fill-gray-400 hover:fill-red-400' }}" xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 512 512">
                                                    <path
