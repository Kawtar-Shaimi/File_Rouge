                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #6b7280; font-size: 14px; line-height: 1.6;">
                                A new order has just been placed on our platform. Below are the details:
                            </p>
                                        ...
                                        @foreach ($order->orderBooks as $orderBook)
                                            <tr>
                                                <td style="padding: 8px; border: 1px solid #e5e7eb;">
                                                    <a href="{{ route('admin.books.show', $orderBook->book->uuid) }}" style="text-decoration: underline; color: #4f46e5;">
                                                        {{ $orderBook->book->name }}
                                                    </a>
                                                </td>
