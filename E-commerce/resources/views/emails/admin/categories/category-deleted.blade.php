                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #6b7280; font-size: 14px; line-height: 1.6;">
                                A category has been <strong>deleted</strong> by {{ $admin_name }} from the website. The deleted category's
                                details are as follows:
                            </p>
                            <p style="color: #6b7280; font-size: 14px; line-height: 1.6;">
                                <strong>Category Name:</strong> {{ $category_name }}<br>
                                <strong>Deleted At:</strong> {{ $deleted_at }}
                            </p>

                            <div style="margin: 30px 0; text-align: center;">
                                <a href="{{ route('admin.categories.index') }}" style="background-color: #c084fc; color: white; text-decoration: none; padding: 12px 24px; border-radius: 8px; display: inline-block; font-weight: bold;">
                                    View All Categories
                                </a>
                            </div>
                        </td>
