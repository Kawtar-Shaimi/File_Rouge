                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #6b7280; font-size: 14px; line-height: 1.6;">
                                We regret to inform you that your book titled <strong>{{ $book_name }}</strong> has been
                                deleted by the admins.
                            </p>
                            <p style="color: #6b7280; font-size: 14px; line-height: 1.6;">
                                If you would like to review the book or make any further changes, please visit your
                                profile below.
                            </p>
