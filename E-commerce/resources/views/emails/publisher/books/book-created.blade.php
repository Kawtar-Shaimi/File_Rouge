...
<head>
    <meta charset="UTF-8">
    <title>Book Created Successfully</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #6b7280; font-size: 14px; line-height: 1.6;">
                                Congratulations! Your book titled <strong>{{ $book_name }}</strong> has been successfully created and is now live on the platform.
                            </p>
                            <p style="color: #6b7280; font-size: 14px; line-height: 1.6;">
                                You can now view your book and make any additional changes or updates.
                            </p>
