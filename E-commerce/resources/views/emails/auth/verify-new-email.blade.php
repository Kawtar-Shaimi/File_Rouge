                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1); overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="margin: 0 0 20px 0; color: #4b5563;">Verify Your New Email Address</h2>
                            <p style="color: #6b7280; font-size: 14px; line-height: 1.6;">
                                Your email address has been updated. Please click the button below to verify your new email address to access your account.
                            </p>
                            <p style="color: #6b7280; font-size: 14px; line-height: 1.6;">
                                The verification link will expire in 15 minutes. If you did not update your email address, no further action is required.
                            </p>
                            ...
                            <p style="color: #9ca3af; font-size: 12px;">
                                If you’re having trouble clicking the "Verify New Email" button, copy and paste the URL below into your web browser:
                            </p>
