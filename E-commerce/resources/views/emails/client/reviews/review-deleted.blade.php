                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #6b7280; font-size: 14px; line-height: 1.6;">
                                We wanted to inform you that your review for the book "<strong>{{ $book->name }}</strong>"
                                has been deleted by the admins.
                            </p>
                            <p style="color: #6b7280; font-size: 14px; line-height: 1.6;">
                                This action was taken due to a violation of our review guidelines. If you believe this was
                                done in error, please reach out to our support team for further clarification.
                            </p>
