                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #6b7280; font-size: 14px; line-height: 1.6;">
                                Your profile has been <strong>updated successfully</strong>. All changes have been saved.
                            </p>
                            <p style="color: #6b7280; font-size: 14px; line-height: 1.6;">
                                You can now view your updated profile information and manage your account settings.
                            </p>

                            <div style="margin: 30px 0; text-align: center;">
                                <a @if($guard == 'admin') href="{{ route('admin.profile') }}" @elseif ($guard == 'publisher')
                                href="{{ route('publisher.profile') }}" @else href="{{ route('client.index') }}" @endif
