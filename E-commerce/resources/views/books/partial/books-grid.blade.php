                            ...
                            @if ($book->isInCart)
                                <div class="flex items-center border border-gray-200 rounded-md overflow-hidden shadow-sm">
                                    <button id="removeFromCartBtn-{{ $book->uuid }}"
                                        class="flex-none w-8 h-8 flex items-center justify-center bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 text-white text-sm font-medium shadow-inner disabled:opacity-40 transition-all duration-200"
                                    ...
                                    <input type="text" id="quantity-{{ $book->uuid }}" name="quantity"
                                        ...
                                        class="flex-grow w-8 h-8 text-center bg-white text-gray-800 border-0 text-sm font-medium focus:outline-none" readonly disabled>
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <div class="relative flex-none w-20">
                                            <input type="number" id="quantity-{{ $book->uuid }}" name="quantity"
                                                ...
                                                class="w-full h-9 pl-3 pr-6 border border-gray-200 text-sm rounded-md focus:ring-1 focus:ring-teal-500 focus:border-teal-500">
                                            <span class="absolute inset-y-0 right-0 flex items-center pr-2 text-gray-400 pointer-events-none">
                                                <span class="text-xs">Qty</span>
                                            </span>
                                        </div>
                                        <button class="flex-1 h-9 px-3 bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 text-white text-sm font-medium rounded-md shadow-sm hover:shadow transform hover:translate-y-px transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                            ...
                            <div class="mt-2">
                                ...
                                @else
                                    <button id="toggleWishlistBtn-{{ $book->uuid }}"
                                        ...
                                        <svg class="w-4 h-4 mr-1.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
