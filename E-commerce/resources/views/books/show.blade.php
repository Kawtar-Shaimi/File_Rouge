                    ...
                    @auth('client')
                        <div>
                            <div id="actions" class="mt-4 flex items-end space-x-2">
                                ...
                                @endif
                                <div id="toggleWishlistBtn-{{ $book->uuid }}"
                                    class="w-1/5 inline-flex justify-center items-center" 
                                    ...
                                    <div class="flex justify-center items-center w-12 h-12 cursor-pointer" style="outline:none !important; -webkit-tap-highlight-color: transparent !important;">
                                        <svg class="w-7 h-7 transition-transform duration-200 transform hover:scale-110 {{ $book->isInWishlist ? 'text-red-500 fill-red-500' : 'text-gray-400 fill-gray-400 hover:fill-red-400' }}" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 512 512">
                                            <path
