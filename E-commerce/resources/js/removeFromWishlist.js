        ...
        success: function(response, _, xhr) {
            if (xhr.status === 200) {
                $(`#toggleWishlistBtn-${productId}`).replaceWith(`
                    <button id="toggleWishlistBtn-${productId}" class="w-1/5 bg-blue-500 hover:bg-blue-600 disabled:bg-blue-300 text-white font-bold py-2 px-4 rounded-e-lg border-s border-black" onclick="addToWishlist(${productId})">
