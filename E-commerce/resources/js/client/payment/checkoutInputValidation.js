    ...
    $("#shipping_name").on("input", function () {
        ...
        if (shippingName.length < 3) {
            $("#shippingNameError").text(
                "Shipping name must be at least 3 characters."
            );
            $("#shipping_name")
                .removeClass(
            ...
            $("#shippingNameError").text(
                "Shipping name must be less than 60 characters."
            );
            $("#shipping_name")
                .removeClass(
                    "border-green-500  focus:ring focus:ring-green-300"
            ...
            $("#shippingNameError").text(
                "Shipping name must only contain letters and spaces."
            );
            $("#shipping_name")
                .removeClass(
                    "border-green-500  focus:ring focus:ring-green-300"
    ...
    $("#shipping_email").on("input", function () {
        ...
        if (shippingEmail.length < 3) {
            $("#shippingEmailError").text(
                "Shipping email must be at least 3 characters."
            );
            $("#shipping_email")
                .removeClass(
                    "border-green-500  focus:ring focus:ring-green-300"
            ...
            $("#shippingEmailError").text(
                "Shipping email must be less than 150 characters."
            );
            $("#shipping_email")
                .removeClass(
                    "border-green-500  focus:ring focus:ring-green-300"
    ...
    $("#shipping_phone").on("input", function () {
        ...
        if (shippingPhone.length < 6) {
            $("#shippingPhoneError").text(
                "Shipping phone must be at least 6 characters."
            );
            $("#shipping_phone")
                .removeClass(
                    "border-green-500  focus:ring focus:ring-green-300"
            ...
            $("#shippingPhoneError").text(
                "Shipping phone must be less than 20 characters."
            );
            $("#shipping_phone")
                .removeClass(
                    "border-green-500  focus:ring focus:ring-green-300"
    ...
    $("#shipping_address").on("input", function () {
        ...
        if (shippingAddress.length < 3) {
            $("#shippingAddressError").text(
                "Shipping address must be at least 3 characters."
            );
            $("#shipping_address")
                .removeClass(
                    "border-green-500  focus:ring focus:ring-green-300"
    ...
    $("#shipping_country").on("input", function () {
        ...
        if (shippingCountry.length < 3) {
            $("#shippingCountryError").text(
                "Shipping country must be at least 3 characters."
            );
            $("#shipping_country")
                .removeClass(
                    "border-green-500  focus:ring focus:ring-green-300"
            ...
            $("#shippingCountryError").text(
                "Shipping country must be less than 100 characters."
            );
            $("#shipping_country")
                .removeClass(
                    "border-green-500  focus:ring focus:ring-green-300"
            ...
            $("#shippingCountryError").text(
                "Shipping country must only contain letters and spaces."
            );
            $("#shipping_country")
                .removeClass(
                    "border-green-500  focus:ring focus:ring-green-300"
    ...
    $("#shipping_city").on("input", function () {
        ...
        if (shippingCity.length < 3) {
            $("#shippingCityError").text(
                "Shipping city must be at least 3 characters."
            );
            $("#shipping_city")
                .removeClass(
                    "border-green-500  focus:ring focus:ring-green-300"
            ...
            $("#shippingCityError").text(
                "Shipping city must be less than 100 characters."
            );
            $("#shipping_city")
                .removeClass(
                    "border-green-500  focus:ring focus:ring-green-300"
            ...
            $("#shippingCityError").text(
                "Shipping city must only contain letters and spaces."
            );
            $("#shipping_city")
                .removeClass(
                    "border-green-500  focus:ring focus:ring-green-300"
    ...
    $("#shipping_postal_code").on("input", function () {
        ...
        if (shippingPostalCode.length < 3) {
            $("#shippingPostalCodeError").text(
                "Shipping postal code must be at least 3 characters."
            );
            ...
            $("#shippingPostalCodeError").text(
                "Shipping postal code must be less than 20 characters."
            );
            $("#shipping_postal_code")
                .removeClass(
                    "border-green-500  focus:ring focus:ring-green-300"
            ...
            $("#shippingPostalCodeError").text(
                "Shipping postal code cannot be empty."
            );
            $("#shipping_postal_code")
                .removeClass(
                    "border-green-500  focus:ring focus:ring-green-300"
