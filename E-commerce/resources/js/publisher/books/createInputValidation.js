$(document).ready(function() {
    ...
    $('#price').on('input', function() {
        ...
        if (price <= 0) {
            ...
            $('#price').removeClass('border-green-500  focus:ring focus:ring-green-300').addClass('border-red-500  focus:ring focus:ring-red-300');
            $('#add-book').prop('disabled', true);
        } else {
            $('#priceErr').text('');
            $('#price').removeClass('border-red-500  focus:ring focus:ring-red-300').addClass('border-green-500  focus:ring focus:ring-green-300');
            $('#add-book').prop('disabled', false);
        }
    });
    ...
    $('#stock').on('input', function() {
        ...
        if (stock <= 0) {
            ...
            $('#stock').removeClass('border-green-500  focus:ring focus:ring-green-300').addClass('border-red-500  focus:ring focus:ring-red-300');
            $('#add-book').prop('disabled', true);
        } else {
            $('#stockErr').text('');
            $('#stock').removeClass('border-red-500  focus:ring focus:ring-red-300').addClass('border-green-500  focus:ring focus:ring-green-300');
            $('#add-book').prop('disabled', false);
        }
    });
    ...
    $('#image').on('change', function() {
        ...
        if (image === '') {
            ...
            $('#image').removeClass('border-green-500  focus:ring focus:ring-green-300').addClass('border-red-500  focus:ring focus:ring-red-300');
            $('#add-book').prop('disabled', true);
        } else {
            $('#imageErr').text('');
