...
$(document).ready(function () {
    $("#status").on("change", function () {
        ...
        if (
            ...
            $("#status-error").text(
                'Status must be "Pending", "In Shipping", "Completed", or "Cancelled".'
            );
            $("#status")
                .removeClass(
    ...
    $("#reason").on("input", function () {
        if ($(this).val().length < 3) {
            ...
            $("#reason")
                .removeClass("border-green-500 focus:ring focus:ring-green-500")
                .addClass("border-red-500 focus:ring focus:ring-red-500");
            $("#update-status").prop("disabled", true);
            ...
            $("#reason-error").text("");
            $("#reason")
                .removeClass("border-red-500 focus:ring focus:ring-red-500")
                .addClass("border-green-500 focus:ring focus:ring-green-500");
            $("#update-status").prop("disabled", false);
        }
    });
